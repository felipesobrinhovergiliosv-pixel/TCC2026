...
public class ModuloController {
    ...
    @PostMapping
    public Modulo adicionar(@RequestBody @Valid Modulo modulo) { return service.salvar(modulo); }

    @DeleteMapping("/{moduloId}")
    public void remover(@PathVariable Long moduloId){ service.excluir(moduloId);}

    @PutMapping("/{moduloId}")
    public Modulo alterar(@PathVariable Long moduloId, @RequestBody @Valid Modulo modulo){
